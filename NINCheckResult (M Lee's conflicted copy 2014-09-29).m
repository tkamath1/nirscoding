...
% % Identify date of recording from filename
% [junk,date]=strtok(dataFileNm,'_');
% [date,junk]=strtok(date,'_');
% slash='/20'
% date=[date,slash]
% date=date([1,2,7,3,4,7,8,9,5,6])
% if date(1,1)=='0'
% date=date(:,2:end)
% end
% if date(1,3)=='0'
% datetest=date([1,2,4,5,6,7,8,9])
% end
